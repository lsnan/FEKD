...
```
Due to dataset licensing and preprocessing dependencies, 
we provide a simplified data loading and augmentation pipeline. 
For full reproduction, please follow standard COD dataset preparation protocols.
